...
class ezfSolrDocumentFieldOcEvent extends ezfSolrDocumentFieldBase
{
    ...
    public static function generateAttributeFieldName(eZContentClassAttribute $classAttribute, $type)
    {
        ...
        return parent::ATTR_FIELD_PREFIX . $classAttribute->attribute( 'identifier' ) . '_' . self::FIELD_TYPE_MAP;
    }
    ...
    public function getData()
    {
      ...
      <field name="attr_event_dp">1530536400 1530543600</field>
      <field name="attr_event_dp">1530622800 1530630000</field>
      <field name="attr_event_dp">1530709200 1530716400</field>
      <field name="attr_event_dp">1530795600 1530802800</field>
      <field name="attr_event_dp">1530882000 1530889200</field>
      */

      /*
       <field name="shift">2 4</field>
      <field name="shift">7 9</field>
      <field name="shift">11 13</field>
      <field name="shift">15 18</field>
      <field name="shift">25 30</field>
       */

      //$data [$attributeFieldName] = $datePoints;
      //$data [$attributeFieldName] = array('1 1', '2 4', '2 5', '2 6', '2 7', time() . ' ' . time(), time() . ' ' . time(), time() . ' ' . time());
      //$data [$attributeFieldName] = array('1530226800 1530234000', '1530399600 1530406800', '1530486000 1530493200', '1530658800 1530666000');
      //$data [$attributeFieldName] = array('2 4', '7 9', '11 13', '15 18', '25 30');
