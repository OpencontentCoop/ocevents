          ...
          viewCalendar.fullCalendar({
            ...
            loading: function (isLoading, view) {
              if (isLoading) {// isLoading gives boolean value
                ...
                if ($('.fc-loader').length == 0) {
                  $('.fc-center').append('<i class="fa fa-circle-o-notch fa-spin fc-loader" style="font-size:20px; color: #b31a34; margin-top: 8px"></i>');
                }
                $('.fc-loader').removeClass('hidden');
              } else {
                //hide your loader here
                console.log('not is Loading');
                $('.fc-loader').addClass('hidden');
              }
            }
          });
