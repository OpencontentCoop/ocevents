...
{def $reply_limit=20
     ...
     $recurrences = $node.data_map.recurrences.content
     $from_time = recurrences_strtotime( $recurrences.events.[0].start )
     $to_time = recurrences_strtotime( $recurrences.events.[0].end )}
