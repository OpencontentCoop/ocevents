        ...
        <div class="col-sm-10">
          <div class="form-group repeat-interval">
            <div data-resize="auto"
              ...
              <ul class="dropdown-menu" role="menu">
                <li data-value="none"><a href="#">{'None (run once)'|i18n('ocevents/attribute')}</a></li>
                {*<li data-value="hourly" data-text="hour(s)"><a href="#">Hourly</a></li>*}
                <li data-value="daily" data-text="day(s)"><a href="#">{'Daily'|i18n('ocevents/attribute')}</a></li>
                {*<li data-value="weekdays"><a href="#">Weekdays</a></li>*}
                <li data-value="weekly" data-text="week(s)"><a href="#">{'Weekly'|i18n('ocevents/attribute')}</a></li>
                <li data-value="monthly" data-text="month(s)"><a href="#">{'Monthly'|i18n('ocevents/attribute')}</a></li>
            ...
            <div class="repeat-panel repeat-every-panel repeat-hourly repeat-daily repeat-weekly hide" aria-hidden="true">
              <label id="MySchedulerEveryLabel" class="inline-form-text repeat-every-pretext">{'every'|i18n('ocevents/attribute')}</label>
          ...
          <div class="repeat-panel repeat-yearly hide" aria-hidden="true">
            ...
            <div class="form-group repeat-yearly-day">
              ...
              <div class="radio pull-left">
                <label class="radio-custom"><input class="sr-only" type="radio" name="repeat-yearly" value="bysetpos">{'on the'|i18n('ocevents/attribute')}</label>
              </div>
